...
localStorage.setItem("apihost", "https://uuxia.cn");
localStorage.setItem("wshost", "wss://uuxia.cn/websocket");
...
function login() {
    ...
    jQuery.ajax({
        ...
        success: function(results) {
            ...
            setCookie('cook',JSON.stringify(results));
            if (results.code == 0) {
                window.isLogin = true;
                window.location.href = 'admin/index.html'
            } else {
